...
RfuBot=["ue1d6a794435130d139f9c5dde19aa9e5",lineMID]
...
settings = {
    ...
    "welcome":"สวัสดีครับ ยินดีต้อนรับ 😇",
    "kick":"เอาหวะใจแม่งได้หวะ",
    "bye":"นายทำดีใจแล้วเพื่อนลาก่อน",
    "Respontag":"เหมือนเหงาอะ 🙄",
...
【さัএπัஞ✵ບิथℓℓҨतΩ】:
List opsi
robot Pasangan Hidup :
beginner Only Status fast_forward 180K/Bulan
robot Systim Contract :
https://line.me/R/ti/p/~self_js
beginner Only Curhat fast_forward 100K/Bulan
beginner Zona Friend + TTM
beginner Zona Nyaman + Full Care + On 5day + 2 day free fast_forward 300K/Bulan
writing_hand Bisa Requests Mau Berapa Lama Durasi Buat Debay.
page_with_curl
* Always on 24 Jam
* Keuntungan Banyak
...
""",
    ...
    "comment1":"SELF BOT BY:MAX",
    "comment":"SELF BOT BY:MAX",
    "userAgent": [
...
╠ ✯͜͡❂ คำสั่ง2
╠ ✯͜͡❂ คำสั่ง3
╠ ✯͜͡❂ เช็ค [เช็คการตั้งค่า]
╠ ✯͜͡❂ ผส [คท.ผู้สร้าง]
╠ ✯͜͡❂ ข้อมูล [ข้อมูลตัวเอง]
╠ ✯͜͡❂ ข้อมูล @ [คนที่แทค]
╠ ✯͜͡❂ ไอดี @ [ไอดีคนแทค]
╠ ✯͜͡❂ ชื่อ @ [ชื่อคนแทค]
╠ ✯͜͡❂ ตัส @ [สเตตัสคนแทค]
...
╠ ✯͜͡❂ ปก @ [ดึงปก]
╠ ✯͜͡❂ คท @ [คอนแทคคนแท็ก]
╠ ✯͜͡❂ วีดีโอโปร @ [วีดีโอคนแทค]
╠ ✯͜͡❂ ไอดีล่อง [ไอดีล่องหน]
╠ ✯͜͡❂ คทล่อง [คอนแทคล่องหน]
╠ ✯͜͡❂ แทคล่อง [ร่องหน]
╠ ✯͜͡❂ ปฏิทิน [เช็ควันเวลา]
╠ ✯͜͡❂ ส่งเสียงกลุ่ม [ข้อความ]
╠ ✯͜͡❂ ส่งเสียงแชท [ข้อความ]
╠ ✯͜͡❂ ประกาศกลุ่ม [ข้อความ]
╠ ✯͜͡❂ ประแชท [ข้อความ]
╠ ✯͜͡❂ ส่งรูปภาพตามกลุ่ม [ลิ้งรูป]
╠ ✯͜͡❂ ส่งรูปภาพตามแชท [ลิ้งรูป]
╠ ✯͜͡❂ รีบูส [รีบูสระบบใหม่]
╠ ✯͜͡❂ ออน [เช็คเวลาออน]
╠ ✯͜͡❂ แอด
╠ ✯͜͡❂ ชื่อกลุ่ม
╠ ✯͜͡❂ ไอดีกลุ่ม
...
╠ ✯͜͡❂ ปวดตับ
╠ ✯͜͡❂ ปฏิทิน
╠ ✯͜͡❂ รูปภาพ [ชื่อรูปภาพ]
╠ ✯͜͡❂ ค้นหารูปภาพ [ชื่อรูปภาพ]
╠ ✯͜͡❂ ยูทูป [ข้อความ]
╠ ✯͜͡❂ เพลง [ชื่อเพลง]
╠ ✯͜͡❂ Lyric
╠ ✯͜͡❂ ScreenshootWebsite
╠ ✯͜͡❂ หนัง [ชื่อหนัง]
╠ ✯͜͡❂ วีดีโอ [ชื่อวีดีโอ]
╠ ✯͜͡❂ รูปการ์ตูน [ชื่อรูป]
╠ ✯͜͡❂ ไอจี [ชื่อยูส]
╠ ✯͜͡❂ Urban
╠ ✯͜͡❂ กูเกิ้ล [ข้อความ]
╠ ✯͜͡❂ โย่ว
...
╠ ✯͜͡❂ เพื่อน
╠ ✯͜͡❂ ไอดีเพื่อน
╠ ✯͜͡❂ Gcancel:(จำนวนสมาชิก)
╚═════════════════
╔═════════════════
╠BY:【さัএπัஞ✵ບิथℓℓҨतΩ】
╚═════════════════
http://line.me/ti/p/~self_js
"""
    return myHelp
...
#==============================================================================#
                    ...
                    line.sendMessage(to, "กำลังรีบูส... โปรดรอสักครู่...")
                    line.sendMessage(to, "รีบูสเสร็จสิ้น...")
                    restartBot()
                elif text.lower() == 'ออน':
                    timeNow = time.time()
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                               ...
                               line.sendText(msg.to,"[จะออกไปแตะขอบฟ้า]")
                               line.createGroup("[SELFBOT-BY:MAX]",mi_d)
                               line.sendText(msg.to,"[จะออกไปแตะขอบฟ้า]")
                               line.createGroup("[SELFBOT-BY:MAX]",mi_d)
                               line.sendText(msg.to,"[จะออกไปแตะขอบฟ้า]")
...
#==============================================================================#
                  ...
                  if msg._from in admin:
                    ...
                    line.sendMessage(msg.to, t1 + txt + t2)						
                        ...
                        line.sendMessage(msg.to,"ส่ง คท")                            
...
#==============================================================================#
        ...
        if op.type == 26:
            ...
            if settings ["Api"] == True:
            	if msg.text in ["พี่แม็ค","ป๊าแม็ค","ลุง","แม็ค","นาย","เพื่อน","จาร์ย","อาจาร์ย","เฮีย"]:
                    line.sendMessage(msg.to, str(settings["comment"]))
            if settings ["Api"] == True:
                         ...
                         if settings['detectMention'] == True:
                             ...
                             for mention in mentionees:
                                   if mention['M'] in lineMID:
                                          ...
                                          line.sendMessage(to,str(settings["[ ระบบตอบกลับอัตโนมัติ ]"]))
                                          break
                if msg.contentType == 0 and sender not in lineMID and msg.toType == 2:
                    if "MENTION" in list(msg.contentMetadata.keys()) != None:

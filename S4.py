...
RfuBot=[lineMID]
Family=["ue1d6a794435130d139f9c5dde19aa9e5",lineMID]
admin = "ue1d6a794435130d139f9c5dde19aa9e5" 
admin=['ue1d6a794435130d139f9c5dde19aa9e5',lineMID]
...
settings = {
    ...
    "pname": {},
    "pro_name": {},
    "man1":"ตั้งข้อความแท็ก",
    "man2":"ตั้งข้อความแท็ก",
    "man3":"ตั้งข้อความแท็ก",
...
╠════════════════
╠ ✯͜͡❂คำสั่ง ▶ คำสั่ง
╠ ✯͜͡❂คำสั่ง2 ▶ คำสั่งเชล
╠ ✯͜͡❂คำสั่ง3 ▶ คำสั่งกับแทค
╠ ✯͜͡❂คำสั่ง4 ▶ คำสั่งตั้งค่า
╠ ✯͜͡❂คำสั่ง5 ▶ คำสั่งค้นหา
╠ ✯͜͡❂คำสั่ง6 ▶ คำสั่งกลุ่ม
╠ ✯͜͡❂คำสั่ง7 ▶ คำสั่งเลียนแบบ
╠ ✯͜͡❂คำสั่ง8 ▶ คำสั่งล่องหน
╠════════════════
╠❂【さัএπัஞ✵ບิथℓℓҨतΩ】
╚════════════════
"""
...
╠ ✯͜͡❂  คำสั่งตั่งค่า 
╠════════════════
╠ ✯͜͡❂เปิดเข้า ▶ เข้ากลุ่มออโต้
╠ ✯͜͡❂ปิดเข้า ▶ ปิดเข้ากลุ่มออโต้
╠ ✯͜͡❂เปิดบล็อค ▶ ออโต้บล็อค
╠ ✯͜͡❂ปิดบล็อค ▶ ปิดออโต้บล็อค
╠ ✯͜͡❂เปิดออก ▶ ออกแชทรวม
╠ ✯͜͡❂ปิดออก ▶ ปิดออกแชทรวม
╠ ✯͜͡❂เปิดอ่าน ▶ อ่านออโต้
╠ ✯͜͡❂ปิดอ่าน ▶ ปิดอ่านออโต้
╠ ✯͜͡❂เปิดแทค ▶ ตอบกลับคนแทค
╠ ✯͜͡❂ปิดแทค ▶ ปิดตอบกลับคนแทค
╠ ✯͜͡❂เปิดแทค2 ▶ แทคส่งรูป
╠ ✯͜͡❂ปิดแทค2 ▶ ปิดแทคส่งรูป
╠ ✯͜͡❂เปิดเชคติ้ก ▶ ดูลิ้งสติ้กเก้อ
╠ ✯͜͡❂ปิดเชคติ้ก ▶ ปิดดูลิ้งสติ้กเก้อ
╠ ✯͜͡❂เปิดดูคนอ่าน ▶ จับคนอ่าน
╠ ✯͜͡❂ปิดดูคนอ่าน ▶ ปิดจับคนอ่าน
╠ ✯͜͡❂เปิดข้อมูล ▶ เปิดอ่านmid  
╠ ✯͜͡❂ปิดข้อมูล ▶ ปิดอ่านmid  
╠ ✯͜͡❂เปิดลิ้ง ▶ ดูลิ้งโพส
╠ ✯͜͡❂ปิดลิ้ง ▶ ปิดดูลิ้งโพส
╠ ✯͜͡❂ตั้งเข้า:▶ตั้งข้อความต้อนเข้า
╠ ✯͜͡❂ตั้งออก:▶ ตั้งข้อความต้อนออก
╠ ✯͜͡❂ตั้งแทค:▶ ตั้งกล่าวถึงคนแทค
╠ ✯͜͡❂เช็คเข้า ▶ เช็คต้อนรับคนเข้า
╠ ✯͜͡❂เช็คออก ▶ เช็คบอกลาคนออก
╠ ✯͜͡❂เช็คแทค ▶ เช็คแทค
╠ ✯͜͡❂ต้อนรับ  on ▶ เปิดต้อนรับกับออก
╠ ✯͜͡❂ต้อนรับ  off ▶ ปิดต้อนรับกับออก
╠════════════════
╠❂【さัএπัஞ✵ບิथℓℓҨतΩ】
╚════════════════
"""
...
╠ ✯͜͡❂  คำสั่งแทค
╠════════════════
╠ ✯͜͡❂คท [แทค] ▶ แทคคนที่จะเอาคท    
╠ ✯͜͡❂มิด [แทค] ▶ ลงmidคนอื่น
╠ ✯͜͡❂ชื่อ [แทค] ▶ ลงชื่อคนอื่น
╠ ✯͜͡❂ตัส [แทค] ▶ ลงตัสคนอื่น
╠ ✯͜͡❂ดิส [แทค] ▶ ลงดิสคนอื่น
╠ ✯͜͡❂ปก [แทค] ▶ ลงปกคนอื่น
╠ ✯͜͡❂วีดีโอ [แทค] ▶ ลงวีดีโอปกคนอื่น
╠ ✯͜͡❂ก็อป [แทค] ▶ ก็อปปกคนอืน
╠ ✯͜͡❂ข้อมูล [แทค] ▶ ดูข้อมูลคนแทค
╠ ✯͜͡❂ไป [แทค] ▶ เตะละเชิญกลับ
╠ ✯͜͡❂เตะ [แทค] ▶ เตะด้วยแทค
╠ ✯͜͡❂จุก [แทค] ▶ เตะกลบแชท
╠ ✯͜͡❂แบน [แทค] ▶ แทคคนจะลงดำ
╠════════════════
╠❂【さัএπัஞ✵ບิथℓℓҨतΩ】
╚════════════════
"""
...
╠ ✯͜͡❂เชคดำ
╠ ✯͜͡❂ล้างดำ
╠ ✯͜͡❂ชื่อ: ข้อความ ➠เปลี่ยนชื่อ
╠ ✯͜͡❂ตัส: ข้อความ ➠เปลี่ยนตัส
╠════════════════
╠❂【さัএπัஞ✵ບิथℓℓҨतΩ】
╚════════════════
"""
...
╠ ✯͜͡❂  คำสั่งค้นหา
╠════════════════
╠ ✯͜͡❂พูด ข้อความ ▶ สั่งสิริพูด
╠ ✯͜͡❂ยูทูป ข้อความ ▶ ค้นหาในยูทูป
╠ ✯͜͡❂เขียน ข้อความ ▶ เขียน
╠ ✯͜͡❂รูปมา ข้อความ ▶ ส่งรูป
╠ ✯͜͡❂กาตูน ข้อความ ▶ ลงรูป
╠════════════════
╠❂【さัএπัஞ✵ບิथℓℓҨतΩ】
╚════════════════
"""
...
╠ ✯͜͡❂  คำสั่งกลุ่ม
╠════════════════
╠ ✯͜͡❂กลุ่ม ▶ ข้อมูลกลุ่ม
╠ ✯͜͡❂ไอดีกลุ่ม ▶ไอดีห้อง
╠ ✯͜͡❂ชื่อกลุ่ม ▶ ชื่อห้อง
╠ ✯͜͡❂ชื่อกลุ่ม ข้อความ ▶ เปลี่ยนชื่อห้อง
╠ ✯͜͡❂กลุ่ม ▶ รูปกลุ่ม
╠ ✯͜͡❂บ้าน ▶ ดูรายชื่อกลุ่ม
╠ ✯͜͡❂สมาชิก ▶ รายชื่อคนในห้อง
╠ ✯͜͡❂เปิดลิ้ง ▶ เปิดลิ้งกลุ่ม
╠ ✯͜͡❂ปิดลิ้ง ▶ ปิดลิ้งกลุ่ม
╠ ✯͜͡❂ลิ้ง ▶ ขอลิ้งกลุ่ม
╠ ✯͜͡❂แทค ▶ แทคคนในกลุ่ม
╠ ✯͜͡❂ตั้งเวลา ▶ ตั้งเวลา
╠ ✯͜͡❂ปิดเวลา ▶ ปิดเวลา
╠ ✯͜͡❂รีเวลา ▶ ลบเวลาคนอ่าน
╠ ✯͜͡❂อ่าน ▶ ดูคนอ่าน
╠ ✯͜͡❂#ประกาศ: ข้อความ ▶ ส่งแชททุกห้อง
╠ ✯͜͡❂ด่ามัน ▶ คำด่า
╠ ✯͜͡❂รัส ▶ ค.ทไวรัส
╠════════════════
╠❂【さัএπัஞ✵ບิथℓℓҨतΩ】
...
#===============หาชื่อล่อนหน===============================================================#
                    ...
                    line.sendMessage(to, "BOT BY: MAXSY")
                    ...
                    start = time.time()
                    line.sendMessage(to,"[กำลังวัดสปีด]...")
                    ...
                    try:
                        ...
                        ret_ = "╔══[ ข้อมูล ]" 
                        ret_ += "\n╠ ✯͜͡❂ ชื่อ ═ {}".format(contact.displayName)
                        ret_ += "\n╠ ✯͜͡❂ กลุ่ม ═ {}".format(str(len(grouplist)))
                        ret_ += "\n╠ ✯͜͡❂ เพื่อน ═ {}".format(str(len(contactlist)))
                        ret_ += "\n╠ ✯͜͡❂ บล็อค ═ {}".format(str(len(blockedlist)))
                        ret_ += "\n╠══[สถานะ]"
                        ret_ += "\n╠ ✯͜͡❂ ผู้สร้าง ═ {}".format(creator.displayName)
                        ret_ += "\n╚══[【さัএπัஞ✵ບิथℓℓҨतΩ】]"
...
#==============================================================================#
                    ...
                    try:
                        ...
                        if settings["autoCancel"]["on"] == True:ret_+="\n╠ ✯͜͡❂ ยกเลิกเชิญกลุ่มเมื่อมีสมาชิกต่ำกว่า: " + str(settings["autoCancel"]["members"]) + " → ✔"
                        else: ret_ += "\n╠ ✯͜͡❂ ยกเลิกเชิญกลุ่ม    ✘ "						
...
#==============================================================================#
                    ...
                    for a in range(k+1):
                        ...
                        line.sendMessage(to, "สมาชิก {} คน".format(str(len(nama)))) 
                elif text.lower() == 'แทค':
                    group = line.getGroup(msg.to)
                    nama = [contact.mid for contact in group.members]
                    k = len(nama)//20
